...
<div class="w3l-hero-headers-9">
  <div class="css-slider">
    ...
    <section class="slide slide-one">
      <div class="container">
        <div class="banner-text">
          <h4>Be the best U</h4>
          <h3>Beauty is our duty<br>
            We'll style while you smile!</h3>
    ...
    <section class="slide slide-two">
      <div class="container">
        <div class="banner-text">
          <h4>Share your aesthetic vibe</h4>
          <h3>Sit back. Relax.<br>
          Leave it to us.</h3>
          <a href="book-appointment.php" class="btn logo-button top-margin">Get An Appointment</a>
        </div>
      </div>
    ...
    <input id="slide-3" type="radio" name="slides" checked>
    <section class="slide slide-three">
      <div class="container">
        <div class="banner-text">
          <h4>Define Feminine</h4>
          <h3>Effortless beauty<br>
            Nothing brighter than your smile!</h3>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            <div>
                            <h4 class=" ">Highest Rate Salon in HCM</h4>
                            <p class="para ">for your best beauty experience</p>
	...
	<div class="team-single-main ">
		<div class="container">
				...
				<div class="column2 image-text">
					...
					<p class="para  text ">
						Best Beauty expert within your reach. Our Salon provide well trained beauty professionals for beauty services including Facial, Clean Up, Waxing,Pedicure, Manicure, etc.</p>
        ...
        <div class="container">
            <div class=" row">
                ...
                <div class="col-lg-6 about-right-faq align-self">
                    <h3 class="title-big"><a href="about.html">Modern Lab - High Technology</a></h3> <br>
                    <h3 class="title-big"><a href="about.html">Verified Beauticians</a></h3>
                    <p class="mt-3 para"> SRG spa services include massage body, natural facials treatment and more.</p>
                        <div class="hair-cut">
                            <div >
                    ...
                    <div  class="image-right">
                        <ul class="w3l-right-book">
                            ...
                            <li><span class="fa fa-check" aria-hidden="true"></span><a href="services.php">Nails Treatment</a></li>
