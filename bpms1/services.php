                ...
                <div class="col-lg-4 col-md-6 col-sm-6 propClone">
                 <img src="admin/images/<?php echo $row['Image']?>" alt="product" height="200" width="400" class="img-responsive about-me">
                    <div class="about-grids ">
                        <hr>
                        <h5 class="para" style="font-weight: 500;"><?php  echo $row['ServiceName'];?></h5>
                        <p class="para " style="font-size: 15px ;"><?php  echo $row['ServiceDescription'];?> </p>
                        <!-- <br> -->
                        <p class="para pb-5" style="color: #6667AB">$<?php  echo $row['Cost'];?> </p>
