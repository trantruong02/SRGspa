      ...
      <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
        <ul class="nav" id="side-menu">
          ...
          <li>
            ...
            <li>
              <a href="add-products.php"><i class="fa fa-cogs nav_icon"></i>Products<span class="fa arrow"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
            ...
            <li class="">
              <a href="about-us.php"><i class="fa fa-book nav_icon"></i>Pages content <span class="fa arrow"></span></a>
              <ul class="nav nav-second-level collapse">
                <li>
            ...
            <li>
              <a href="order-list.php"><i class="fa fa-check-square-o nav_icon"></i>Order List</a>
            </li>
