...
if(isset($_POST['submit']))
  {
    ...
    $cid=$_GET['viewid'];
    $status=$_POST['status'];
    $query = mysqli_query($con, "UPDATE  tblbook SET Status='$status' WHERE ID ='$cid'");
    if ($query) {
    
    echo '<script>alert("All remark has been updated.")</script>';
    echo "<script type='text/javascript'> document.location ='order-list.php'; </script>";
  }
  else
    {
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Order</h3>
					<div class="table-responsive bs-example widget-shadow">
						
						<h4>Order Details:</h4>
						<?php
                            $cid=$_GET['viewid'];
                            $ret=mysqli_query($con,"SELECT * FROM tblorder WHERE ID = $cid");
                            //$cnt=1;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="status" class="form-control wd-450" required="true" >
                                                <option value="Confirmed" ="true">Confirmed</option>
                                            </select>
                                        </td>
                                    </tr>
