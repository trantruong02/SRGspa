    ...
    if($ret["usertype"] == "user" )
        {
            ...
            $_SESSION['user_name']=$ret['FirstName'];
            header('location:index.php');

        } 
    elseif($ret["usertype"] == "admin")
        {

            $_SESSION['bpmsuid']=$ret['ID'];
            header('location:../bpms1/admin/dashboard.php');
        }
    else
        {
            // var_dump($ret['usertype']);
                ...
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        ...
                        <div class="twice-two" style="padding-top: 30px;">
                            <a class="link--gray" style="color: blue;" href="signup.php">Not a member yet? Sign Up</a> <br>
