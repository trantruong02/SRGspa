...
<html lang="en">
  <head>
    ...
    <title>SRG Spa | Appointment</title>
...
<section class="w3l-inner-banner-main">
 ...
 Book Appointment
            ...
            <p class="tiltle-para ">Thanks for choosing one of the most recognized and trusted spa brands in HCM.<br> Your appointment will be duly noted.</p>
        </div>
</div>
</div>
...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p class="para"><a href="tel:+0962646239">+<?php  echo $row['MobileNumber'];?></a></p>
                        </div>
                    </div>
